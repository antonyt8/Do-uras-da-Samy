...
export default function PedidosPage() {
  ...
  const fetchPedidos = () => {
    setLoading(true);
    authFetch("https://sammy-back.onrender.com/api/pedidos")
      .then((res) => res.json())
      .then((data) => {
        setPedidos(data);
        setLoading(false);
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Gerencie os pedidos de clientes e associe receitas
          </p>
        </div>
        {isAuthenticated && (
          <button
      ...
      {loading ? (
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Comece criando seu primeiro pedido para registrar vendas e produção
          </p>
          <button
            onClick={() => setShowForm(true)}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded shadow-lg text-center">
            <p className="mb-4">
              ...
              <b>{deletingPedido.nomeCliente}</b>?
            </p>
            {deleteError && (
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                onClick={() => handleDelete(deletingPedido)}
