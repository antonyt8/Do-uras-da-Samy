...
export default function LoginModal({ onSuccess, onClose }: LoginModalProps) {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(30, 42, 56, 0.10)" }}
    >
      <form
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-2 text-[#1E2A38] text-center">
          Acesso do Gestor
        </h2>
        ...
        <div className="mb-4">
          <label className="block mb-1 text-sm font-medium text-[#3E3E3E]">
            Usuário
          </label>
          <input
        ...
        {error && (
          <div className="text-red-600 mb-4 text-center font-semibold bg-red-50 border border-red-200 rounded p-2">
            {error}
          </div>
        )}
